...
export async function renderLogin(app, host) {
  ...
  wrap.innerHTML = `<div class="login-head"><div class="login-logo"><img src="assets/companion/blip-base-blue.webp" alt=""></div><div><h1>Blipwork</h1><p class="muted small">Grade 11 · homework</p></div></div>`;
